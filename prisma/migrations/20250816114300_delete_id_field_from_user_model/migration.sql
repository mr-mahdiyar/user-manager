...
INSERT INTO "new_User" ("baseId", "birthDate", "caseNumber", "family", "fatherName", "membershipDate", "name", "nationalCode", "phone", "statusId") SELECT "baseId", "birthDate", "caseNumber", "family", "fatherName", "membershipDate", "name", "nationalCode", "phone", "statusId" FROM "User";
DROP TABLE "User";
